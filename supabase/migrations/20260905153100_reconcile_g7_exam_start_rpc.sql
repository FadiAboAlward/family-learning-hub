-- Forward reconciliation for production databases that already applied
-- 20260905112741 before the concurrency hardening was merged. Fresh databases
-- receive the same definition from the original migration; this migration makes
-- existing production state converge without rewriting migration history.
