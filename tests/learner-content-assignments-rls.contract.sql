...
begin
  ...
  where n.nspname = 'public'
    and c.relname = 'learner_content_assignments';
  ...
  if exists (
    ...
    where schemaname = 'public'
      and tablename = 'learner_content_assignments'
  ) then
    raise exception 'learner_content_assignments must not expose browser RLS policies';
  end if;
