...
7. each server-evaluated submitted question contributes one mastery evidence item to its primary linked learning concept; secondary concept links do not double-count the question.
