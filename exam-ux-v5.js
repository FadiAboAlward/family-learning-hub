(() => {
  const TOTAL = 10;
  const STATE_KEY = 'exam_nav_answered_v5';
  let queued = false;
  ...
  const simple = {
    1:{s:['نريد كسرًا يساوي 3/8.','نضرب 3 و8 في 2، فنحصل على 6 و16.','إذن 3/8 = 6/16.'],l:['الكسر المكافئ يعني نفس الكمية.','لا نغيّر البسط وحده أو المقام وحده.','نختار الضرب في 2.','3 × 2 = 6.','8 × 2 = 16.','إذن 6/16 هو الجواب الصحيح.']},
    2:{s:['نوحّد المقامين حتى تكون المقارنة عادلة.','2/3 = 4/6، و1/2 = 3/6.','4/6 أكبر من 3/6، إذن 2/3 أكبر.'],l:['المقامات مختلفة، فلا نقارن بسرعة.','المقام المشترك هو 6.','نحوّل 2/3 إلى 4/6.','نحوّل 1/2 إلى 3/6.','نقارن 4 و3.','إذن 2/3 > 1/2.']},
    3:{s:['نوحّد المقامين إلى 15.','2/5 = 6/15، و1/3 = 5/15.','6/15 أكبر، إذن 2/5 أكبر.'],l:['نريد أجزاءً من الحجم نفسه.','15 مقام مشترك مناسب.','2/5 تصبح 6/15.','1/3 تصبح 5/15.','نقارن 6 و5.','إذن 2/5 > 1/3.']},
    4:{s:['نحوّل الكسور كلها إلى مقام 12.','تصبح البسوط: 9، 4، 10، 7.','نرتبها 4، 7، 9، 10؛ إذن 1/3 < 7/12 < 3/4 < 5/6.'],l:['التصاعدي يعني من الأصغر للأكبر.','المقام 12 مناسب للجميع.','3/4 = 9/12.','1/3 = 4/12، و5/6 = 10/12، و7/12 كما هو.','نرتب البسوط: 4 ثم 7 ثم 9 ثم 10.','نعيدها لكسورها الأصلية فنحصل على الترتيب الصحيح.']},
    5:{s:['الأقرب يعني المسافة الأصغر.','5/7 = 25/35، و3/5 = 21/35.','21 أصغر من 25، إذن منزل رهام أقرب.'],l:['نبحث عن المسافة الأقل.','نوحّد المقامين إلى 35.','5/7 تصبح 25/35.','3/5 تصبح 21/35.','21/35 أصغر من 25/35.','إذن منزل رهام هو الأقرب.']},
    6:{s:['نوحّد المقامين إلى 100.','13/20 = 65/100، و16/25 = 64/100.','65 أكبر من 64، إذن 13/20 أكبر.'],l:['المقامات مختلفة.','نستخدم 100 مقامًا مشتركًا.','13/20 تصبح 65/100.','16/25 تصبح 64/100.','نقارن 65 و64.','إذن 13/20 هو الأكبر.']},
    7:{s:['الأكثر اقتصادية تستهلك وقودًا أقل.','13/40 = 39/120، و23/60 = 46/120.','39 أقل من 46، إذن المركبة الأولى أكثر اقتصادية.'],l:['نفهم المطلوب أولًا: الأقل استهلاكًا هو الأفضل.','نوحّد المقامين إلى 120.','13/40 تصبح 39/120.','23/60 تصبح 46/120.','39 أقل من 46.','إذن المركبة الأولى أكثر اقتصادية.']},
    8:{s:['نوحّد المقامين إلى 15.','3/5 = 9/15، و2/3 = 10/15.','9 أقل من 10، إذن 3/5 أصغر.'],l:['لا نحكم من المقامين وحدهما.','نستخدم 15 مقامًا مشتركًا.','3/5 تصبح 9/15.','2/3 تصبح 10/15.','نقارن 9 و10.','إذن 3/5 < 2/3.']},
    9:{s:['نوحّد الكسور كلها إلى مقام 12.','تصبح: 6/12، 8/12، 9/12، 10/12.','إذن الترتيب هو 1/2 < 2/3 < 3/4 < 5/6.'],l:['التصاعدي يعني من الأصغر للأكبر.','المقام 12 مناسب للجميع.','1/2 = 6/12.','2/3 = 8/12، و3/4 = 9/12، و5/6 = 10/12.','نرتب 6 ثم 8 ثم 9 ثم 10.','نعيدها إلى الكسور الأصلية.']},
    10:{s:['نريد كسرًا مساويًا لـ4/10.','نقسم 4 و10 على 2، فنحصل على 2 و5.','إذن 4/10 = 2/5.'],l:['الكسر المكافئ له نفس القيمة.','يمكننا التبسيط بالقسمة على العدد نفسه.','4 و10 يقبلان القسمة على 2.','4 ÷ 2 = 2.','10 ÷ 2 = 5.','إذن 2/5 هو الجواب الصحيح.']}
  };
  ...
  function loadAnswered(){
    try { const x=JSON.parse(sessionStorage.getItem(STATE_KEY)||'[]'); return Array.from({length:TOTAL},(_,i)=>!!x[i]); }
    catch { return Array(TOTAL).fill(false); }
  }
  function saveAnswered(a){ sessionStorage.setItem(STATE_KEY,JSON.stringify(a)); }
  function currentIndex(){
    const t=document.querySelector('.exam-status .topline b')?.textContent||'';
    const m=t.match(/السؤال\s+(\d+)\s+من/); return m?Number(m[1]):0;
  }
  ...
  function jumpTo(target){
    ...
    const go=()=>{
      ...
      if(!cur||cur===target||guard++>15) return;
  ...
  document.addEventListener('click',e=>{
    if(e.target.closest?.('#fractionExam')) sessionStorage.removeItem(STATE_KEY);
    markAnswerClick(e);
  },true);
